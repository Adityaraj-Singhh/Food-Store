            ...
            <div className="checkout-page row gap-3 justify-content-between px-3 px-lg-5 my-5 text-black">
                <form action="" method="post" className="checkout-service p-3 bg-white col-12 col-lg-8 border border-1">
                    ...
                    <div className='d-flex gap-2 mt-5'>
                        ...
                        <label className='w-50'>
                            <span>Last Name *</span>
                            <input type="text" name="lastname" defaultValue={user.lastname || ''} readOnly  className="form-control w-100 rounded-0 p-2"/>
                        </label>
                    </div>
                    <div className='my-4'>
                    ...
                    <div>
                        <label className='w-100'>
                            <span>Address *</span>
                            <input type="text" name="address" defaultValue={user.address} readOnly className="form-control w-100 rounded-0 p-2"/>
                        </label>
                    </div>
                    <div className='my-4'>
